import { Transform, Readable as Readable$1 } from 'node:stream';
...
function log(message, ...args) {
    process$1.stderr.write(`${util.format(message, ...args)}${EOL}`);
}
...
const http = __importStar$2(require$$0$1);
const https = __importStar$2(require$$1$2);
    ...
    async connect(req, opts) {
        ...
        if (proxy.protocol === 'https:') {
            ...
            socket = tls$1.connect({
                ...this.connectOpts,
                servername: servername && net$1.isIP(servername) ? undefined : servername,
            });
        }
        else {
...
class NodeHttpClient {
    ...
    getOrCreateAgent(request, isInsecure) {
        ...
        if (isInsecure) {
            ...
            agent = new https$1.Agent(Object.assign({ 
...
function asStream(method) {
    return method.asNodeStream().then((response) => {
        return {
            ...response,
            body: Readable$1.toWeb(response.body),
        };
    });
}
